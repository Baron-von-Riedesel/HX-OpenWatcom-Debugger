...
inherit_class:
                ...
                case LF_STRUCTURE:
                    ...
                    break;
                default:
                    Confused( 1, "TypeListWalk.1", p->common.code );
                }
                goto new_list;
            case LF_ENUMERATE:
            ...
            case LF_VFUNCOFF:
                ...
                break;
            default:
                Confused( 1, "TypeListWalk.2", p->common.code );
                return( WR_FAIL );
            }
                ...
                location_context *lc, location_list ll, unsigned long *disp )
{
    ...
    if( ti.kind != TK_POINTER ) {
		Confused( 1, "GetVirtBaseDisp.1", ti.kind );
    }
    ...
    if( p->pointer.f.type >= CV_FIRST_USER_TYPE ) {
        ...
        if( p->common.code != LF_ARRAY || p->array.f.elemtype >= CV_FIRST_USER_TYPE ) {
			Confused( 1, "GetVirtBaseDisp.2", p->common.code );
        }
    ...
    case 4:
        *disp = tmp.u32;
        break;
    default:
		Confused( 1, "GetVirtBaseDisp.3", ti.size );
        return( DS_ERR|DS_FAIL );
    }
    return( DS_OK );
}
            ...
            unsigned_32 vfunc_off, location_context *lc, location_list *ll )
{
    ...
    case CV_VTFAR32:
        ...
        break;
    default:
		Confused( 1, "VFuncLocation", vfshape );
        return( DS_ERR|DS_FAIL );
    }
    ds = DoIndirection( ii, &ti, lc, ll );
    if( ds != DS_OK ) return( ds );
...
method_addr:
    ...
    case LF_ENUMERATE:
        return( DS_FAIL );
    default:
		Confused( 1, "TypeSymGetAddr", p->common.code );
        return( DS_FAIL );
    }
    return( DS_OK );
}
                ...
                imp_type_handle *it, location_context *lc, type_info *ti )
{
    ...
    case LF_REFSYM:
        break;
    default:
		Confused( 1, "ImpTypeInfo", p->common.code );
        return( DS_ERR|DS_FAIL );
    }
...
dip_status ImpTypeBase( imp_image_handle *ii, imp_type_handle *it, imp_type_handle *base )
{
    ...
    case LF_REFSYM:
        break;
    default:
		Confused( 1, "ImpTypeBase", p->common.code );
        return( DS_ERR|DS_FAIL );
    }
    return( DS_OK );
}
                ...
                array_info *ai )
{
    ...
    case LF_DIMCONU:
        ...
        case 4:
            ...
            break;
        default:
			Confused( 1, "GetArrayRange.1", ti.size );
            return( DS_ERR|DS_FAIL );
        }
        break;
    case LF_DIMCONLU:
        ...
        case 4:
            ...
            break;
        default:
			Confused( 1, "GetArrayRange.2", ti.size );
            return( DS_ERR|DS_FAIL );
        }
        break;
    case LF_DIMVARU:
    ...
    case LF_DIMVARLU:
        ...
        break;
    default:
		Confused( 1, "GetArrayRange.3", code );
        return( DS_ERR|DS_FAIL );
    }
