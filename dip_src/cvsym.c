                            ...
                            char **namep, unsigned *lenp, s_all **pp )
{
    ...
    case S_GTHREAD32:
        ...
        break;
    default:
        Confused( 0, "SymGetName", p->common.code );
    }
    name = (char *)p + skip;
...
#define DEFTYPE( t ) if( idx == 0 ) idx = t;
    ...
    case S_GTHREAD32:
        ...
        break;
    default:
        Confused( 0, "SymTypeIdx", p->common.code );
        idx = 0;
    }
    return( idx );
}
                ...
                imp_sym_handle *is, location_context *lc, location_list *ll )
{
    ...
    case S_GTHREAD32:
        ...
        break;
    default:
        Confused( 0, "ImpSymLocation", p->common.code );
        return( DS_FAIL );
    }
    return( DS_OK );
}
                ...
                imp_sym_handle *is, location_context *lc, sym_info *si )
{
    ...
    case S_LABEL32:
        si->kind = SK_CODE;
        break;
    case S_BLOCK16:  /* japheth */
    case S_BLOCK32:  /* japheth */
        si->kind = SK_CODE;
        break;
    default:
        Confused( 0, "DIPImpSymInfo", p->common.code );
        return( DS_FAIL );
    }
    return( DS_OK );
}
